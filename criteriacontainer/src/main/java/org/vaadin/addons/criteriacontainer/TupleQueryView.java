...
public class TupleQueryView implements QueryView, ValueChangeListener {

	private LazyQueryView lazyQueryView;
	private TupleQueryFactory queryFactory;
	private TupleQueryDefinition queryDefinition;
     ...
     */
    public TupleQueryView(final TupleQueryDefinition queryDefinition, final TupleQueryFactory queryFactory) {
	 ...
	 */
	public TupleQueryFactory getQueryFactory() {
		return queryFactory;
	}
	...
	@Override
	public TupleQueryDefinition getQueryDefinition() {
