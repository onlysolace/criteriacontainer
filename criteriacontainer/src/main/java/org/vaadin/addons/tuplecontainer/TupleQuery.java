...
public final class TupleQuery implements Query, Serializable {
     ...
     */
    public TupleQuery(final TupleQueryDefinition criteriaQueryDefinition) {
    ...
    private Object fromItem(final Item item) {
        return ((TupleItem)item).getTuple();
    }
}